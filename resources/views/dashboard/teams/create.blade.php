...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">اضافه عضو</h4>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <a class="btn btn-primary btn-block" href="{{ route('teams.index') }}">جميع الاعضاء</a>
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('teams.store') }}" class="needs-validation " enctype="multipart/form-data">
                        ...
                        <div class="row row-xs formgroup-wrapper">
                            ...
                            <div class="col-md-6 mg-t-20 mg-md-t-0">
                                <label class="form-lable h5" for="status">حاله العضو</label>
                                <div class="form-group">
