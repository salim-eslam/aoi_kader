...
<link href="{{URL::asset('assets/adminadmin//plugins/gallery/gallery.css')}}" rel="stylesheet">
@endsection
@section('page-header')
				<!-- breadcrumb -->
...
@section('content')
				...
				<div class="demo-gallery">
					<ul id="lightgallery" class="list-unstyled row row-sm pr-0">
						<li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('assets/admin/img/photos/1.jpg')}}" data-src="{{URL::asset('assets/img/photos/1.jpg')}}" data-sub-html="<h4>Gallery Image 1</h4>" >
							<a href="">
								<img class="img-responsive" src="{{URL::asset('assets/admin/img/photos/1.jpg')}}" alt="Thumb-1">
							</a>
						</li>
						<li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('assets/admin/img/photos/2.jpg')}}" data-src="{{URL::asset('assets/img/photos/2.jpg')}}" data-sub-html="<h4>Gallery Image 2</h4>" >
							<a href="">
								<img class="img-responsive" src="{{URL::asset('assets/admin/img/photos/2.jpg')}}" alt="Thumb-1">
							</a>
						</li>
						<li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('assets/admin/img/photos/3.jpg')}}" data-src="{{URL::asset('assets/img/photos/3.jpg')}}" data-sub-html="<h4>Gallery Image 3</h4>" >
							<a href="">
								<img class="img-responsive" src="{{URL::asset('assets/admin/img/photos/3.jpg')}}" alt="Thumb-1">
							</a>
						</li>
						<li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('assets/admin/img/photos/4.jpg')}}" data-src="{{URL::asset('assets/img/photos/4.jpg')}}" data-sub-html="<h4>Gallery Image 4</h4>" >
							<a href="">
								<img class="img-responsive" src="{{URL::asset('assets/admin/img/photos/4.jpg')}}" alt="Thumb-1">
							</a>
						</li>
						<li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('assets/admin/img/photos/5.jpg')}}" data-src="{{URL::asset('assets/img/photos/5.jpg')}}" data-sub-html="<h4>Gallery Image 5</h4>" >
							<a href="">
