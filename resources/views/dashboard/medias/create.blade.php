...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">اضافه ميديا</h4>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <a class="btn btn-primary btn-block" href="{{ route('medias.index') }}">جميع الاعمال</a>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="formData" method="post" action="{{ route('medias.store') }}" class="needs-validation " enctype="multipart/form-data">
                        @csrf
                        <div class="row row-xs formgroup-wrapper">
                            ...
                            <div class="col-md-6 mg-t-20 mg-md-t-0">
                                <label class="form-lable h5" for="type">النوع</label>
                                <div class="form-group">
                                    <select class="form-control select2-search" id="type" name="type" onchange="show()">
                                        <option selected disabled>اختر نوع الميديا</option>
                                        <option value="video">فيديو</option>
                                        <option value="image">صوره</option>
                                    </select>
                                </div>
                            </div>
                            <div id="input" class="col-md-6 mg-t-20 mg-md-t-0">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="الفيديو" type="text"
                                        name="file">
                                </div><!-- main-form-group -->
                            </div> --}}
                            <div class="col-md-6 mg-t-20 mg-md-t-0">
