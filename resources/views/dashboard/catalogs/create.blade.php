...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">اضافه كتالوج</h4>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <a class="btn btn-primary btn-block" href="{{ route('cataloges.index') }}">جميع الكتالوجات</a>
        </div>
    </div>
    <!-- breadcrumb -->
@endsection
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('cataloges.store') }}" class="needs-validation " enctype="multipart/form-data">
                        @csrf
                        <div class="row row-xs formgroup-wrapper">
                            ...
                            <div class="col-md-6">
                                <label class="form-label h5">اضافه الملف</label>
                                <div class="form-group">
                                    <input class="form-control" placeholder="قم برفع الملف" type="file"
                                        name="file">
                                </div><!-- main-form-group -->
                            </div>
                            <div class="col-md-6 mg-t-20 mg-md-t-0">
                                <label class="form-lable h5" for="status">حاله الكتالوج</label>
                                <div class="form-group">
