...
<div class="breadcrumb-header justify-content-between">
    ...
    <div class="d-flex my-xl-auto right-content">
        <a class="btn btn-primary btn-block" href="{{ route('slidbars.create') }}">اضافه عرض</a>
    </div>
    @endcan
</div>
<!-- breadcrumb -->
                         ...
                         <tbody>
                              @foreach ($images as $slidbar)
                                 <tr>
                                     ...
                                     <td>{{ $slidbar->getTranslation('title', 'ar')  }}</td>
                                     <td>{{ $slidbar->getTranslation('body', 'ar')  }}</td>
                                     ...
                                     <td>
                                        ...
                                        <a href="{{ route('slidbars.edit', $slidbar->id) }}" class="btn btn-sm btn-info"
                                            title="تعديل"><i class="las la-pen"></i></a>
                                            @endcan
                                            @can('slidbar-delete')

                                            <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                            data-user_id="{{ $slidbar->id }}" data-username="{{ $slidbar->name }}"
     ...
     <div class="modal" id="modaldemo8">
         <div class="modal-dialog modal-dialog-centered" role="document">
             <div class="modal-content modal-content-demo">
                 ...
                 <form action="{{ route('slidbars.destroy',0) }}" method="post">
                     {{ method_field('delete') }}
                     {{ csrf_field() }}
                     <div class="modal-body">
                         <p>هل انت متاكد من عملية الحذف ؟</p><br>
                         <input type="hidden" name="slidbar_id" id="user_id" value="">
