...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">اضافه تخفيض</h4>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <a class="btn btn-primary btn-block" href="{{ route('departments.index') }}">جميع التخفيضات</a>
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('offers.store') }}" class="needs-validation ">
                        ...
                        <div class="row row-xs formgroup-wrapper">
                            ...
                            <div class="col-md-6 mg-t-20 mg-md-t-0">
                                <label class="form-label h5">قيمه الخصم بالنسبه المئويه</label>
                                <div class="form-group">
                                    <input class="form-control" placeholder="ادخل قيمه الخصم بالنسبه المئويه" type="text"
                                        name="value">
                                </div><!-- main-form-group -->
                            </div>
                            <div class="col-md-6 mg-t-20 mg-md-t-0">
