...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">abouts</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة
                abouts</span>
        </div>
    </div>
    {{-- @can('about-create') --}}
    ...
    <div class="d-flex my-xl-auto right-content">
        <a class="btn btn-primary btn-block" href="{{ route('abouts.create') }}">اضافه عرض</a>
    </div>
    {{-- @endcan --}}
</div>
<!-- breadcrumb -->
         ...
         <div class="card">
             <div class="card-header pb-0">
                 <div class="col-sm-1 col-md-2">
                     @can('اضافة مستخدم')
                         <a class="btn btn-primary btn-sm" href="{{ route('abouts.create') }}">اضافة about</a>
                     @endcan
                 </div>
             </div>
             <div class="card-body">
                         ...
                         <tbody>
                              @foreach ($abouts as $about)
                                 <tr>
                                     <td>{{ $about->id }}</td>
                                     <td>
                                        <a type="image" target="_blank" href="{{'/images/abouts/'.$about->image}}">
                                            <img class="rounded float-start h-25"  style="max-width: 25%;" src="{{'/images/abouts/'.$about->image}}">
                                        </a>
                                    </td>

                                     <td>{{ $about->getTranslation('title', 'ar')  }}</td>
                                     {{-- <td>{{ $about->getTranslation('body', 'ar')  }}</td> --}}
                                     ...
                                     <td>
                                        ...
                                        <a href="{{ route('abouts.edit', $about->id) }}" class="btn btn-sm btn-info"
                                            ...
                                            data-user_id="{{ $about->id }}" data-username="{{ $about->name }}"
