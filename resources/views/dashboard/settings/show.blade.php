            ...
            <div class="card card-primary">
                ...
                <div class="card-body ">
                    ...
                    <div class="form-group">
                        ...
                        <a type="image" target="_blank" href="{{'/images/previos_work/layouts/'.$previos_work->layout}}">
                            <img class="rounded float-start h-25"  style="max-width: 25%;" src="{{'/images/previos_work/layouts/'.$previos_work->layout}}">
                        </a>
                    </div>
                ...
                <div class="card-footer">
                    <div class="btn-icon-list">
                        ...
                        <form action="{{ route('previos_work.destroy', $previos_work['id']) }}" method="POST" class="mr-3">
                            @method('DELETE')
                            @csrf
                        ...
                        <div class="d-flex my-xl-auto mr-1 right-content">
                            <a class="btn btn-primary btn-block" href="{{ route('previos_work_file_add',$previos_work->id) }}">اضافه مديا</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            @foreach ($previos_work->files as $file)
                                @if($file->type=='image')
                                    <tr>
                                        <td>{{ $file->id }}</td>
                                        <td>
                                            <a type="image" target="_blank" href="{{'/images/previos_work/images/'.$file->file}}">
                                                <img class="rounded float-start h-25"  style="max-width: 25%;" src="{{'/images/previos_work/images/'.$file->file}}">
                                            </a>
                                        </td>
                                        <td>{{ $file->type }}</td>
