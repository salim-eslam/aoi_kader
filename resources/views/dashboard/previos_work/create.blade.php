...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">اضافه عمل سابق</h4>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <a class="btn btn-primary btn-block" href="{{ route('previos_works.index') }}">جميع الاعمال</a>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="formData" method="post" action="{{ route('previos_works.store') }}" class="needs-validation " enctype="multipart/form-data">
                        @csrf
                        <div class="row row-xs formgroup-wrapper">
                            ...
                            <div class="col-md-6 mg-t-20 mg-md-t-0">
                                ...
                                <div class="form-group">
                                    <textarea id="Pre_work_description_ar" name="description_ar" value="{{ old('description_ar') }}" class="form-control" placeholder="Textarea" rows="5"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mg-t-20 mg-md-t-0">
                                ...
                                <div class="form-group">
                                    <textarea id="Pre_work_description_en" name="description_en" value="{{ old('description_en') }}" class="form-control" placeholder="Textarea" rows="5"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6 mg-t-20 mg-md-t-0">
                            ...
                            <div class="col-md-6 mg-t-20 mg-md-t-0">
                                <label class="form-lable h5" for="status">حاله العمل</label>
                                <div class="form-group">
